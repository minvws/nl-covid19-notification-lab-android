 ...
 */
package nl.rijksoverheid.en.lab.exposurenotification
...
suspend fun ExposureNotificationClient.getExposureDetails(token: String): List<ExposureInformation> =
    suspendCoroutine { c ->
        getExposureInformation(token).addOnSuccessListener {
